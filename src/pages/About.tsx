            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
              {[
                ...
                <div key={leader.name} className="group">
                  ...
                  <a
                    className="inline-flex items-center gap-3 text-slate-950 dark:text-white font-bold hover:text-blue-600 dark:hover:text-blue-400 transition-all group/link"
          ...
          <div className="max-w-[800px] mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Button
                pillar="education"
                size="lg"
                className="w-full sm:w-auto px-12 py-5 rounded-2xl text-lg hover:shadow-2xl hover:-translate-y-1 active:scale-[0.98]"
              >
              ...
              <Button
                variant="secondary"
                size="lg"
                className="w-full sm:w-auto px-12 py-5 bg-white dark:bg-slate-800 border border-outline-variant/30 dark:border-slate-700 text-slate-950 dark:text-white rounded-2xl text-lg hover:bg-slate-50 dark:hover:bg-slate-700"
                iconLeft={<span className="material-symbols-outlined text-emerald-600 dark:text-emerald-400">chat</span>}
              >
